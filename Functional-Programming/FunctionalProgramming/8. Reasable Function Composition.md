...
For this chapter, the minimum requirement is Go 1.18, as we will be writing code using generics. All the code can be found on GitHub: [https://github.com/ImagineDevOps/Functional-Programming-in-Go./tree/main/Chapter8](https://github.com/ImagineDevOps/Functional-Programming-in-Go./tree/main/Chapter8).
...
The complete example can be found on GitHub: [https://github.com/ImagineDevOps/Functional-Programming-in-Go./tree/main/Chapter8/LazyEvaluation](https://github.com/ImagineDevOps/Functional-Programming-in-Go./tree/main/Chapter8/LazyEvaluation). Let’s start by setting up the `head` function:
